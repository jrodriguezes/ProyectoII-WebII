                                    ...
                                    <form class="p-4 md:p-5" action="{{ route('ride.edit') }}" method="POST">
                                        ...
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            ...
                                            <div class="col-span-2 sm:col-span-1">
                                                ...
                                                @php
                                                    $places = [
                                                        'ciudadquesada', 'florencia', 'quesada', 'pital', 'cutris',
                                                        'venecia', 'aguasarcas', 'pocosol', 'la_fortuna', 'palmera',
                                                        'venado', 'monterrey'
                                                    ];
                                                @endphp
                                                ...
                                                @foreach ($places as $p)
                                                    <option value="{{ $p }}" 
                                                        {{ isset($ride) && $ride->origin === $p ? 'selected' : '' }}>
                                            ...
                                            <div class="col-span-2 sm:col-span-1">
                                                ...
                                                <select id="destination" name="destination"
                                                    ...
                                                    @foreach ($places as $p)
                                                        <option value="{{ $p }}"
                                                            {{ isset($ride) && $ride->destination === $p ? 'selected' : '' }}>
                                                            {{ ucwords(str_replace('_', ' ', $p)) }}
                                                        </option>
                                                    @endforeach
                                                </select>
